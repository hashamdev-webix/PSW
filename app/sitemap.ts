...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    {
      url: `${siteUrl}/hca-staffing-calgary`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    ...
    {
      url: `${siteUrl}/companionship-care-calgary`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${siteUrl}/24-hour-overnight-care-calgary`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${siteUrl}/dementia-alzheimers-care-calgary`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${siteUrl}/personal-care-calgary`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${siteUrl}/senior-care-calgary`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
